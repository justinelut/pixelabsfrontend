...
export default function Footer(){
    ...
    const onSubmit = async (data, e) => {
        e.preventDefault()
        const results = await axios.post(process.env.NEXT_PUBLIC_SERVER_URL+"/api/subscription", { email: data.email}).catch((error) => {
            if (error.response) {
            ...
            <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
                <div className="grid row-gap-10 mb-8 lg:grid-cols-6">
                    ...
                    <div className="md:max-w-md lg:col-span-2">
                        ...
                        {success && <Success message="Thank you for subscribing to our newsletter" />}
                    </div>
                </div>
                <div className="flex flex-col justify-between pt-5 pb-10 border-t border-gray-800 sm:flex-row">
                    ...
                    <div className="flex items-center mt-4 space-x-4 sm:mt-0">
                        <a
                            href="https://twitter.com/pixelabsinc"
                        ...
                        <a
                            href="https://instagram.com/pixelabsinc"
                            className="text-gray-500 transition-colors duration-300 hover:text-teal-accent-400"
                        >
                        ...
                        <a
                            href="https://facebook.com/pixelabsinc"
                            className="text-gray-500 transition-colors duration-300 hover:text-teal-accent-400"
                        >
                            <svg viewBox="0 0 24 24" fill="currentColor" className="h-5">
